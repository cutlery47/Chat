...
class UserView(APIView):
    ...
    def get(self, request, **kwargs):
        services.getUser(request, self.check_object_permissions, kwargs['user_id'])

    def delete(self, request, **kwargs):
        services.deleteUser(request, self.check_object_permissions, kwargs['user_id'])

    def put(self, request, **kwargs):
        services.editUser(request, self.check_object_permissions, kwargs['user_id'])
